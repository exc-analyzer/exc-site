const PATHS: Record<string, string[]> = {
  ...
  scan: [
    "M3 7.5V5a2 2 0 0 1 2-2h2.5",
    "M16.5 3H19a2 2 0 0 1 2 2v2.5",
    "M21 16.5V19a2 2 0 0 1-2 2h-2.5",
    "M7.5 21H5a2 2 0 0 1-2-2v-2.5",
    "M3 12h18",
  ],
  bell: [
  ...
  ticks: ["M18 6 7 17l-5-5", "m22 10-7.5 7.5L13 16"],
  dots: [
    "M6 12a1 1 0 1 1-2 0 1 1 0 0 1 2 0",
    "M13 12a1 1 0 1 1-2 0 1 1 0 0 1 2 0",
    "M20 12a1 1 0 1 1-2 0 1 1 0 0 1 2 0",
  ],
  ban: ["M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18", "m5.64 5.64 12.72 12.72"],
  ...
  github: [
    "M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5a4.3 4.3 0 0 0-1.2-3 4 4 0 0 0-.1-3S17.5 3 15 4.7a13 13 0 0 0-6 0C6.5 3 5.3 3 5.3 3a4 4 0 0 0-.1 3A4.3 4.3 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.4.5-.7 1.2-.8 2V22",
  ...
  palette: [
    "M12 22a10 10 0 1 1 0-20 8.5 8.5 0 0 1 8.5 8.5c0 2-1.6 3.5-3.5 3.5h-1.8a1.7 1.7 0 0 0-1.2 2.9c.3.3.5.8.5 1.3 0 2.1-1.1 3.8-2.5 3.8Z",
    "M7.5 10.5h.01",
    "M11 7.5h.01",
    "M15.5 9h.01",
  ],
  ...
  pin: ["M12 17v5", "M9 10.8V4h6v6.8l3 3.2H6l3-3.2Z"],
  rows: ["M3 5h18", "M3 12h18", "M3 19h18"],
  user: [
    "M19 21v-2a5 5 0 0 0-5-5h-4a5 5 0 0 0-5 5v2",
